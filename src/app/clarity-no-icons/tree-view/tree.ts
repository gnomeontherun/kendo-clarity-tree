...
@Component({
  ...
  template: `
    ...
    <cni-recursive-children
      *ngIf="featuresService.recursion"
      [children]="featuresService.recursion.root"
    ></cni-recursive-children>
  `,
  providers: [CNI_TREE_FEATURES_PROVIDER, TreeFocusManagerService],
  host: {
...
export class CniTree<T> implements AfterContentInit, OnDestroy {
  constructor(
  ...
  @ContentChildren(CniTreeNode) private rootNodes: QueryList<CniTreeNode<T>>;
