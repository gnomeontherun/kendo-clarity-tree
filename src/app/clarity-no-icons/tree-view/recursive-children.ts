...
@Component({
  selector: 'cni-recursive-children',
  template: `
 ...
 */
export class CniRecursiveChildren<T> {
  constructor(public featuresService: CniTreeFeaturesService<T>, @Optional() private expandService: IfExpandService) {
    if (expandService) {
