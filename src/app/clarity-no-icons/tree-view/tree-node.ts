...
import { keyValidator, preventArrowKeyScroll } from './keycode-util';
...
import { CniTreeFeaturesService, CNI_TREE_FEATURES_PROVIDER } from './tree-features.service';
...
@Component({
  selector: 'cni-tree-node',
  templateUrl: './tree-node.html',
  providers: [
    UNIQUE_ID_PROVIDER,
    CNI_TREE_FEATURES_PROVIDER,
    IfExpandService,
...
export class CniTreeNode<T> implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    @Optional()
    @SkipSelf()
    parent: CniTreeNode<T>,
    public featuresService: CniTreeFeaturesService<T>,
  ...
  @ContentChildren(CniTreeNodeLink, { descendants: false })
  private treeNodeLinkList: QueryList<CniTreeNodeLink>;
